    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container-fluid container-xxl d-flex align-items-center">
            <div id="logo" class="me-auto">
                <a href="index.html" class="scrollto"><img src="{{ asset('assets/img/logo.png') }}" alt=""
                        title=""></a>
            </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="assets/img/venue-gallery/1.jpg" class="glightbox" data-gall="venue-gallery">
                                <img src="{{ asset('assets/img/venue-gallery/1.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="assets/img/venue-gallery/2.jpg" class="glightbox" data-gall="venue-gallery">
                                <img src="{{ asset('assets/img/venue-gallery/2.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="assets/img/venue-gallery/3.jpg" class="glightbox" data-gall="venue-gallery">
                                <img src="{{ asset('assets/img/venue-gallery/3.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="assets/img/venue-gallery/4.jpg" class="glightbox" data-gall="venue-gallery">
                                <img src="{{ asset('assets/img/venue-gallery/4.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="assets/img/venue-gallery/5.jpg" class="glightbox" data-gall="venue-gallery">
                                <img src="{{ asset('assets/img/venue-gallery/5.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="assets/img/venue-gallery/6.jpg" class="glightbox" data-gall="venue-gallery">
                                <img src="{{ asset('assets/img/venue-gallery/6.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="assets/img/venue-gallery/7.jpg" class="glightbox" data-gall="venue-gallery">
                                <img src="{{ asset('assets/img/venue-gallery/7.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="assets/img/venue-gallery/8.jpg" class="glightbox" data-gall="venue-gallery">
                                <img src="{{ asset('assets/img/venue-gallery/8.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
